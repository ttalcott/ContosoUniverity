...
namespace ContosoUniversity.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        {
            var schoolContext = _context.Departments.Include(i => i.Administrator);
        ...
        public async Task<IActionResult> Create([Bind("DepartmentID,Budget,InstructorID,FuName,RowVersion,StartDate")] Department department)
        {
